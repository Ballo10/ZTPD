...
SELECT ST_LINESTRING(SR.GEOM) .ST_NUMPOINTS() ST_NUMPOINTS
FROM A6_LRS SR;
...
-- SDO_GEOMETRY(3301, 8307, NULL, SDO_ELEM_INFO_ARRAY(1, 1, 1),
--     SDO_ORDINATE_ARRAY(17.0338122, 54.473702, 102.253899));
